...
<body class="bank_management">
  ...
  <button type="button" class="block" onclick="window.location.href='register_branch.php';">Add Branches</button>
			 <?php    foreach ($data as $key=>$value){ ?>
			 	<img src="<?php echo $value['BRANCH_PIC'];?>" alt="<?php echo $value['BRANCH_ID']; ?>" title="<?php echo $value['BRANCH_ID']; ?>" height="200px" width="250"/>
            <li>Branch ID: <?php echo $value['BRANCH_ID']; ?></li>
            <li>Location:<?php echo $value['LOCATION'];?></li>
            <li>Number of Employees:<?php echo $value['NO_OF_EMPLOYEES'];?></li>
